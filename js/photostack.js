...
;( function( window ) {
	...
	Photostack.prototype._addNavigation = function() {
		...
		this.lin = document.querySelectorAll('.test-flippable');
		this.linkNav = [].slice.call( this.lin );
	}
	...
	Photostack.prototype._initEvents = function() {
		...
		this.linkNav.forEach( function( lin, idx ) {
	...
	Photostack.prototype._showPhoto = function( pos ) {
		...
		if( classie.hasClass( this.currentItem, 'photostack-flip' ) ) {
			...
			//classie.removeClass( this.linkNav[ this.current ], 'flippable' );
		}

		//classie.removeClass( this.linkNav[ this.current ], 'current' );
